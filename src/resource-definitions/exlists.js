...
export default function(globals){
	...
	resource.setActions([
		...
		},
		{
			...
			setErrorMessage   : "Error al intentar crear el lista",
			setCancelMessage  : "Se ha cancelado la creación del lista",
		...
		},
		{
			...
			label             : "Editar lista",
			icon              : "",
			setSuccessMessage : "Se ha editado correctamente el lista",
			setErrorMessage   : "Error al intentar editar el lista",
			setCancelMessage  : "Se ha cancelado la edición del lista",
			getService        : resource.crudServices.show,
		...
		},
		{
			...
			setErrorMessage   : "Error al intentar eliminar el lista",
			setCancelMessage  : "Se ha cancelado la eliminación del lista",
			getService        : resource.crudServices.show,
		...
		},
		{
			...
			label             : "Activar lista",
			icon              : "",
			setSuccessMessage : "Se ha activado correctamente el lista",
			setErrorMessage   : "Error al intentar activar el lista",
			setCancelMessage  : "Se ha cancelado la activación del lista",
		...
		},
		{
			...
			icon              : "",
			setSuccessMessage : "Se ha desactivado correctamente el lista",
			setErrorMessage   : "Error al intentar activar el lista",
			setCancelMessage  : "Se ha cancelado la desactivación del lista",
